               ...
               <v-flex xs12 sm8 md4>
                  <v-card class="elevation-12">
                     <v-toolbar dark color="primary">
                        <v-toolbar-title v-if="mode == 'signup'">Inscription {{ pageWanted }}</v-toolbar-title>
                        <v-toolbar-title v-else>Connexion {{ pageWanted }}</v-toolbar-title>
                     </v-toolbar>
...
export default {
  ...
  data: function () {
      ...
      mounted: function () {
         ...
         if (this.$route.params.data == 'signup') {
            this.mode = 'signup'
         } else {
            this.mode = 'login'
         }
