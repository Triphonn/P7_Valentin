...
@font-face {
    font-family: 'Chirp';
    src: url('./assets/fonts/chirp-bold-web.ttf'),
         url('./assets/fonts/chirp-heavy-web.ttf'),
         url('./assets/fonts/chirp-medium-web.ttf'),
         url('./assets/fonts/chirp-regular-web.ttf'),
}
